"""EquiformerV3 edge embedding, graph attention, and equivariant FFN.

This is the high-level operator surface used by the AdsDrift generator.  It is
kept separate from low-level SO(3) geometry and general-purpose layers so the
adsorbate attention architecture can be changed without touching Wigner code.
"""
...
from .layers import RadialFunction, reduce_edge
...
from .layers import RadialFunction
from .geometry import SO2Linear
from .geometry import (
    SO3Linear,
    SO3Grid
)
from .layers import reduce_edge
from .layers import (
    GraphDropPath,
    EquivariantDropout
)
from .layers import GraphSoftmax
